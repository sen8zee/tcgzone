        ...
        <nav class="navbar">
            ...
            <div class="nav-bottom">
                <ul class="sub-links">
                    ...
                    <li><a href="/tcgzone/customer/Shop Page/shop.php?category=Magic" class="category"><span>Magic</span></a></li>
                    <li><a href="/tcgzone/customer/Shop Page/shop.php?category=One Piece" class="category"><span>One Piece</span></a></li>
                    <li><a href="/tcgzone/customer/My Order Page/my-orders.php">My Orders</a></li>
                </ul>
            </div> 
        </nav>
        ...
        <div class="col-lg-8">
          <div class="panel">
            ...
            <div class="d-flex justify-content-between align-items-center p-3 border-top border-secondary-subtle">
              <a href="/tcgzone/customer/Shop Page/shop.php" class="btn btn-light rounded-pill px-4">Return to Shop</a>
